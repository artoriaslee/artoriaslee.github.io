...
class Plugin extends Controller
{
    protected function get($key)
    {
        ...
        $re = Db::name('options')->where('option_name',$prefix.$key)->field('option_value')->find();
    ...
    protected function delete($key)
    {
        ...
        Db::name('options')->where('option_name', $prefix.$key)->delete();
    }
    ...
    {
        $session_prefix = 'catfish'.str_replace(['/','.',' ','-'],['','?','*','|'],Url::build('/'));
        return Session::get($session_prefix.'user_type');
    }
