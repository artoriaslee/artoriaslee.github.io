...
return [
    ...
    'author' => 'L\'auteur',
    'unknown' => 'Inconnu',
    'Downgrade into the reader' => 'Downgrade au lecteur',
    'Upgrade to author' => 'Mettre à niveau vers l\'auteur',
    'Tourists' => 'Les touristes',
    'Software use protocol' => 'Protocole d\'utilisation du logiciel',
    'Menu' => 'le menu',
    ...
    'Generated' => 'Généré',
    'Catfish Blog Backstage' => 'Catfish Blog d\'arrière - plan',
    'Catfish Blog Management Center' => 'Le Centre de gestion de Catfish Blog',
    'Home' => 'Page d\'accueil',
    ...
    'Themes' => 'Thèmes',
    'Active' => 'Actif',
    'Whether to open the slideshow' => 'Que ce soit pour ouvrir le diaporama',
    'Open the slideshow' => 'Ouvrir le diaporama',
    'Open slides require subject support' => 'Les diapositives ouvertes nécessitent un support de sujet',
    ...
    'Original' => 'Original',
    'Private article' => 'Article privé',
    'Set to a private article' => 'Définir sur un article privé',
    'Private articles only the author himself can see that others can not access' => 'Articles privés seulement l\'auteur lui-même peut voir que les autres ne peuvent pas accéder',
    'public' => 'Ouvertement',
    'Are you sure you want to be open?' => 'Êtes-vous sûr de vouloir être ouvert?',
    'Are you sure you want to make this article public?' => 'Êtes-vous sûr de vouloir rendre cet article public?',
    'Whether to open the message' => 'Que ce soit pour ouvrir un message',
    'Open message' => 'Ouvrir un message',
    'Open message requires subject support' => 'Le message ouvert nécessite un support de sujet',
    ...
    'Cover picture is displayed at the top of the page large picture, the need for subject support, if the theme does not support will not show, it is recommended to upload picture ratio: width × height = 1920 × 600' => 'Image de couverture est affichée en haut de la page grande image, le besoin de soutien de l\'objet, si le thème ne supporte pas ne montrera pas, il est recommandé de télécharger ratio d\'image: largeur × hauteur = 1920 × 600',
    'The background image is the background of the foreground page, requires subject support, and will not be displayed if the theme is not supported' => 'L\'image d\'arrière-plan est l\'arrière-plan de la page de premier plan, nécessite un support de sujet, et ne sera pas affichée si le thème n\'est pas supporté',
    'Cover word color' => 'La couleur du texte de couverture',
    'Set the color of the cover text, the cover text is the text above the cover picture, the need for subject support' => 'Définir la couleur du texte de couverture, le texte de couverture est le texte au-dessus de l\'image de couverture, le besoin de soutien du sujet',
    'Such as' => 'Tel que',
    'Delete the picture' => 'Supprimer l\'image',
    'QQ' => 'QQ',
    'Weibo' => 'Weibo',
    'WeChat' => 'WeChat',
    'Facebook' => 'Facebook',
    'Twitter' => 'Twitter',
    'Skype' => 'Skype',
    'Graduated school' => 'École de fin d\'études',
    'Phone' => 'Téléphone',
    'System Upgrade' => 'Mise à niveau',
    'Catfish Blog has the latest version available' => 'Catfish (poisson-chat) Blog a la dernière version disponible',
    'upgrade immediately' => 'Mettre à jour maintenant',
    'No reminder within a week' => 'Pas de rappel dans une semaine',
    'Get the upgrade package from the link below' => 'Obtenez le package de mise à niveau à partir du lien ci-dessous',
    'Upload upgrade package file, and automatically upgrade' => 'Télécharger le fichier de package de mise à niveau et mettre à niveau automatiquement',
    'Upload upgrade package and start upgrade' => 'Télécharger le package de mise à niveau',
    'Upgrading, please wait ...' => 'Mise à niveau, veuillez patienter ...',
    'Upgrade has been completed' => 'La mise à niveau a été complétée',
    'Upgrade failed' => 'Échec',
    'Catfish Blog official website' => 'Site officiel du Catfish Blog',
    ...
    'The number of records displayed on the home page' => 'Le nombre d\'enregistrements affichés sur la page d\'accueil',
    'You can set the number of records displayed on the homepage' => 'Vous pouvez définir le nombre d\'enregistrements affichés sur la page d\'accueil',
