...
return [
    ...
    'author' => 'Der autor',
    'unknown' => 'Unbekannt',
    'Downgrade into the reader' => 'Downgrade in den Leser',
    'Upgrade to author' => 'Upgrade auf Autor',
    'Tourists' => 'Touristen',
    'Software use protocol' => 'Software-Nutzungsprotokoll',
    'Menu' => 'Menü',
    ...
    'Sign out' => 'Ausloggen',
    'Generated' => 'Generiert',
    'Catfish Blog Backstage' => 'Catfish Blog Backstage',
    'Catfish Blog Management Center' => 'Catfish Blog Verwaltungszentrum',
    'Home' => 'Startseite',
    ...
    'Active' => 'Aktiv',
    'Whether to open the slideshow' => 'Ob die Diashow zu öffnen',
    'Open the slideshow' => 'Öffnen Sie die Diashow',
    'Open slides require subject support' => 'Offene Folien benötigen Unterstützung',
    ...
    'Original' => 'Original',
    'Private article' => 'Privater Artikel',
    'Set to a private article' => 'Auf einen privaten Artikel festlegen',
    'Private articles only the author himself can see that others can not access' => 'Private Artikel nur der Autor selbst kann sehen, dass andere nicht zugreifen können',
    'public' => 'Offen',
    'Are you sure you want to be open?' => 'Bist du sicher, dass du offen sein willst?',
    'Are you sure you want to make this article public?' => 'Möchten Sie diesen Artikel wirklich veröffentlichen?',
    'Whether to open the message' => 'Ob eine Nachricht geöffnet werden soll',
    'Open message' => 'Nachricht öffnen',
    'Open message requires subject support' => 'Offene Nachricht erfordert Betreffunterstützung',
    ...
    'Background picture' => 'Hintergrundbild',
    'Cover picture' => 'Titelbild',
    'Cover picture is displayed at the top of the page large picture, the need for subject support, if the theme does not support will not show, it is recommended to upload picture ratio: width × height = 1920 × 600' => 'Cover-Bild wird am oberen Rand der Seite angezeigt großes Bild, die Notwendigkeit für Betreff-Unterstützung, wenn das Thema nicht unterstützt wird nicht angezeigt, wird empfohlen, Bildverhältnis hochladen: Breite × Höhe = 1920 × 600',
    'The background image is the background of the foreground page, requires subject support, and will not be displayed if the theme is not supported' => 'Das Hintergrundbild ist der Hintergrund der Vordergrundseite, erfordert Betreffunterstützung und wird nicht angezeigt, wenn das Design nicht unterstützt wird.',
    'Cover word color' => 'Die Farbe des Deckentexts',
    'Set the color of the cover text, the cover text is the text above the cover picture, the need for subject support' => 'Legen Sie die Farbe des Deckblatts fest, der Deckentext ist der Text oberhalb des Deckblatts, die Notwendigkeit der Betreffunterstützung',
    'Such as' => 'Sowie',
    'Delete the picture' => 'Löschen Sie das Bild',
    'QQ' => 'QQ',
    'Weibo' => 'Weibo',
    'WeChat' => 'WeChat',
    'Facebook' => 'Facebook',
    'Twitter' => 'Twitter',
    'Skype' => 'Skype',
    'Graduated school' => 'Abschlussschule',
    'Phone' => 'Telefon',
    'System Upgrade' => 'Systemaktualisierung',
    'Catfish Blog has the latest version available' => 'Catfish (Wels) Blog hat die neueste Version verfügbar',
    'upgrade immediately' => 'Jetzt aktualisieren',
    'No reminder within a week' => 'Keine Erinnerung innerhalb einer Woche',
    'Get the upgrade package from the link below' => 'Holen Sie sich das Upgrade-Paket über den folgenden Link',
    'Upload upgrade package file, and automatically upgrade' => 'Upload-Paketdatei hochladen und automatisch aktualisieren',
    'Upload upgrade package and start upgrade' => 'Laden Sie das Upgrade-Paket hoch und starten Sie das Upgrade',
    'Upgrading, please wait ...' => 'Aktualisieren, bitte warten ...',
    'Upgrade has been completed' => 'Das Upgrade wurde abgeschlossen',
    'Upgrade failed' => 'Upgrade fehlgeschlagen',
    'Catfish Blog official website' => 'Catfish Blog offizielle Website',
    ...
    'The number of records displayed on the home page' => 'Die Anzahl der auf der Startseite angezeigten Datensätze',
    'You can set the number of records displayed on the homepage' => 'Sie können die Anzahl der auf der Startseite angezeigten Datensätze festlegen',
    ...
    'Keep the original image after uploading' => 'Behalten Sie das Originalbild nach dem Hochladen',
    'Choose to keep the original image, the width and height of the image can be arbitrary' => 'Wählen Sie, um das Originalbild beizubehalten. Die Breite und Höhe des Bildes kann beliebig sein',
    'Theme setting' => 'Theme-Einstellung',
    'Invalid domain name' => 'Ungültiger Domainname',
    'Other functions' => 'Andere Funktionen',
    'Whether to hide the background address' => 'Gibt an, ob die Hintergrundadresse ausgeblendet werden soll',
    'Hide background address' => 'Hintergrundadresse ausblenden',
    'After hiding, you will not be able to get the login entry by entering the background address' => 'Nach dem Ausblenden können Sie nicht auf die Anmeldeseite zugreifen, indem Sie die Hintergrundadresse eingeben.',
    'Headline' => 'Häuptling',
    'Cancel headline' => 'Brechen Sie die primäre ab',
    'Set as headline' => 'Als primär festlegen',
    'main page' => 'Wichtige Seite',
    'Cancel main page' => 'Wichtige Seite abbrechen',
    'Set as the main page' => 'Als wichtige Seite festlegen',
    'Database backup' => 'Datenbanksicherung',
    'Create a new backup' => 'Erstellen Sie eine neue Sicherung',
    'Backup file name' => 'Name der Sicherungsdatei',
    'Backup date' => 'Sicherungsdatum',
    'Restore database' => 'Datenbank wiederherstellen',
    'Download to local' => 'Auf lokal herunterladen',
    'Are you sure you want to restore the database?' => 'Möchten Sie die Datenbank wirklich wiederherstellen?',
    'After deleting the backup file, the file will disappear' => 'Diese Datei verschwindet nach dem Löschen der Sicherungsdatei.',
    'After restoring the database, the new data will be lost. Please make sure that the latest backup is restored.' => 'Nach dem Wiederherstellen der Datenbank gehen die neuen Daten verloren. Stellen Sie sicher, dass die neueste Sicherung wiederhergestellt wird.',
    'The database has been successfully restored' => 'Die Datenbank wurde erfolgreich wiederhergestellt',
    'Restoring the database, please do not do anything during the restore, please wait...' => 'Wiederherstellung der Datenbank, bitte machen Sie während der Wiederherstellung nichts, bitte warten Sie ...',
    'Backup file has expired' => 'Sicherungsdatei ist abgelaufen',
    'Upload a local backup file and restore' => 'Laden Sie eine lokale Sicherungsdatei hoch und stellen Sie sie wieder her',
    'Upload backup file' => 'Sicherungsdatei hochladen',
    'Upload and restore' => 'Hochladen und wiederherstellen',
    'Upload the backup file downloaded from this page' => 'Laden Sie die von dieser Seite heruntergeladene Sicherungsdatei hoch',
    'Are you sure you want to upload and restore?' => 'Möchten Sie wirklich hochladen und wiederherstellen?',
    'Do not perform any operations during the restore, please be patient and wait for the database restore to end' => 'Führen Sie während der Wiederherstellung keine Vorgänge aus. Seien Sie geduldig und warten Sie, bis die Datenbankwiederherstellung abgeschlossen ist',
    'Backup file not selected' => 'Sicherungsdatei nicht ausgewählt',
    'The database has been restored' => 'Die Datenbank wurde wiederhergestellt',
    'Please select the correct backup file' => 'Bitte wählen Sie die richtige Sicherungsdatei',
    'Error' => 'Fehler',
    'SMTP settings' => 'SMTP-Einstellungen',
    'SMTP server address' => 'SMTP-Serveradresse',
    'The port number' => 'Portnummer',
    'Mailbox user' => 'Postfachbenutzer',
    'Encryption' => 'Verschlüsselungsmethode',
    'Whether to enable SMTP authentication' => 'Gibt an, ob die SMTP-Authentifizierung aktiviert werden soll',
    'Enable SMTP authentication' => 'Aktivieren Sie die SMTP-Authentifizierung',
    'SMTP server address must be filled in' => 'Die SMTP-Serveradresse muss ausgefüllt werden',
    'Port number must be filled in' => 'Portnummer muss ausgefüllt werden',
    'Mailbox users must fill in' => 'Postfachbenutzer müssen ausfüllen',
    'Send a test email' => 'Senden Sie eine Test-E-Mail',
    'Test mail' => 'Mail testen',
    'This is a test email' => 'Dies ist eine Test-E-Mail',
    'Test mail sent successfully' => 'Testmail erfolgreich versendet',
    'Test mail failed to send' => 'Testmail konnte nicht gesendet werden',
    'Whether to open the password recovery function' => 'Gibt an, ob die Passwortwiederherstellungsfunktion geöffnet werden soll',
    'Open the password recovery function' => 'Öffnen Sie die Passwortwiederherstellungsfunktion',
    'SMTP settings must be completed before the password recovery function is enabled' => 'Die SMTP-Einstellungen müssen abgeschlossen sein, bevor die Passwortwiederherstellungsfunktion aktiviert wird.'
];