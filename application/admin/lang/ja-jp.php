...
return [
    ...
    'author' => '著者',
    'unknown' => '不明',
    'Downgrade into the reader' => '読者にダウングレードする',
    'Upgrade to author' => '著者にアップグレードする',
    'Tourists' => '観光客',
    'Software use protocol' => 'ソフトウェア使用プロトコル',
    'Menu' => 'メニュー',
    ...
    'Sign out' => 'やめます',
    'Generated' => '生成されました',
    'Catfish Blog Backstage' => 'Catfish Blogの舞台裏',
    'Catfish Blog Management Center' => 'Catfish Blog 管理センター',
    'Home' => 'ホーム',
    ...
    'Themes' => 'テーマ',
    'Active' => 'アクティブ',
    'Whether to open the slideshow' => 'スライドショーを開くかどうか',
    'Open the slideshow' => 'スライドショーを開く',
    'Open slides require subject support' => '開いているスライドにはサブジェクトサポートが必要です',
    ...
    'Original' => 'オリジナル',
    'Private article' => 'プライベート記事',
    'Set to a private article' => 'プライベート記事に設定する',
    'Private articles only the author himself can see that others can not access' => 'プライベート記事は、著者自身が他者がアクセスできないことを見ることができます',
    'public' => '公然と',
    'Are you sure you want to be open?' => '開いてもよろしいですか？',
    'Are you sure you want to make this article public?' => 'この記事を公開してもよろしいですか？',
    'Whether to open the message' => 'メッセージを開くかどうか',
    'Open message' => 'メッセージを開く',
    'Open message requires subject support' => 'オープンメッセージにはサブジェクトサポートが必要です',
    ...
    'Background picture' => '背景画像',
    'Cover picture' => 'カバー画像',
    'Cover picture is displayed at the top of the page large picture, the need for subject support, if the theme does not support will not show, it is recommended to upload picture ratio: width × height = 1920 × 600' => 'カバー画像がページの上部に表示され、大きな画像、被写体のサポートの必要性、テーマがサポートされていない場合は表示されません、画像の比率をアップロードすることをお勧めします：幅×高さ= 1920×600',
    'The background image is the background of the foreground page, requires subject support, and will not be displayed if the theme is not supported' => '背景画像は、前景ページの背景であり、テーマのサポートが必要であり、テーマがサポートされていない場合は表示されません',
    'Cover word color' => '表紙の色',
    'Set the color of the cover text, the cover text is the text above the cover picture, the need for subject support' => 'カバーテキストの色を設定します。カバーテキストは、カバー画像の上のテキストです。サブジェクトサポートの必要性',
    'Such as' => 'といった',
    'Delete the picture' => '画像を削除する',
    'QQ' => 'QQ',
    'Weibo' => 'Weibo',
    'WeChat' => 'WeChat',
    'Facebook' => 'Facebook',
    'Twitter' => 'Twitter',
    'Skype' => 'Skype',
    'Graduated school' => '卒業学校',
    'Phone' => '電話番号',
    'System Upgrade' => 'アップグレード',
    'Catfish Blog has the latest version available' => 'Catfish Blog最新バージョンが利用可能です',
    'upgrade immediately' => '今すぐアップグレードする',
    'No reminder within a week' => '1週間以内にリマインダーはありません',
    'Get the upgrade package from the link below' => '下のリンクからアップグレードパッケージを入手してください',
    'Upload upgrade package file, and automatically upgrade' => 'アップグレードパッケージファイルをアップロードし、自動的にアップグレードします',
    'Upload upgrade package and start upgrade' => 'アップグレードパッケージをアップロードしてアップグレードを開始する',
    'Upgrading, please wait ...' => 'アップグレード中です、お待ちください...',
    'Upgrade has been completed' => 'アップグレードが完了しました',
    'Upgrade failed' => 'アップグレードに失敗しました',
    'Catfish Blog official website' => 'Catfish Blog公式サイト',
    ...
    'The number of records displayed on the home page' => 'ホームページにはレコード数が表示されます',
    'You can set the number of records displayed on the homepage' => 'ホームページに表示されるレコード数を設定することができます',
    ...
    'Keep the original image after uploading' => 'アップロード後も元の画像を保存する',
    'Choose to keep the original image, the width and height of the image can be arbitrary' => '元の画像を維持するように選択します。画像の幅と高さは任意です。',
    'Theme setting' => 'テーマ設定',
    'Invalid domain name' => '無効なドメイン名',
    'Other functions' => 'その他の機能',
    'Whether to hide the background address' => 'バックグラウンドアドレスを非表示にしますか？',
    'Hide background address' => 'バックグラウンドアドレスを隠す',
    'After hiding, you will not be able to get the login entry by entering the background address' => '非表示にした後は、バックグラウンドアドレスを入力してログインページにアクセスすることはできません。',
    'Headline' => '重要な',
    'Cancel headline' => 'プライマリをキャンセル',
    'Set as headline' => 'プライマリとして設定',
    'main page' => '重要ページ',
    'Cancel main page' => '重要なページをキャンセル',
    'Set as the main page' => '重要ページに設定',
    'Database backup' => 'データベース',
    'Create a new backup' => '新しいバックアップを作成する',
    'Backup file name' => 'バックアップファイル名',
    'Backup date' => 'バックアップ日',
    'Restore database' => 'データベースを復元する',
    'Download to local' => 'ローカルにダウンロード',
    'Are you sure you want to restore the database?' => 'データベースを復元してもよろしいですか？',
    'After deleting the backup file, the file will disappear' => 'このファイルは、バックアップファイルを削除すると消えます。',
    'After restoring the database, the new data will be lost. Please make sure that the latest backup is restored.' => 'データベースを復元した後、新しいデータは失われます。復元が最新であることを確認してください。',
    'The database has been successfully restored' => 'データベースが正常に復元されました',
    'Restoring the database, please do not do anything during the restore, please wait...' => 'データベースを復元しています。復元中は何もしないでください。お待ちください...',
    'Backup file has expired' => 'バックアップファイルの有効期限が切れています',
    'Upload a local backup file and restore' => 'ローカルバックアップファイルをアップロードして復元する',
    'Upload backup file' => 'バックアップファイルをアップロード',
    'Upload and restore' => 'アップロードと復元',
    'Upload the backup file downloaded from this page' => 'このページからダウンロードしたバックアップファイルをアップロードする',
    'Are you sure you want to upload and restore?' => 'アップロードして復元してもよろしいですか？',
    'Do not perform any operations during the restore, please be patient and wait for the database restore to end' => '復元中に操作を実行しないでください。データベースの復元が終了するまでしばらくお待ちください',
    'Backup file not selected' => 'バックアップファイルが選択されていません',
    'The database has been restored' => 'データベースが復元されました',
    'Please select the correct backup file' => '正しいバックアップファイルを選択してください',
    'Error' => 'エラー',
    'SMTP settings' => 'SMTP設定',
    'SMTP server address' => 'SMTPサーバーのアドレス',
    'The port number' => 'ポート番号',
    'Mailbox user' => 'メールボックスユーザー',
    'Encryption' => '暗号化方法',
    'Whether to enable SMTP authentication' => 'SMTP認証を有効にするかどうか',
    'Enable SMTP authentication' => 'SMTP認証を有効にする',
    'SMTP server address must be filled in' => 'SMTPサーバーのアドレスを入力する必要があります',
    'Port number must be filled in' => 'ポート番号を入力する必要があります',
    'Mailbox users must fill in' => 'メールボックスユーザーは入力する必要があります',
    'Send a test email' => 'テストメールを送信する',
    'Test mail' => 'テストメール',
    'This is a test email' => 'これはテストメールです',
    'Test mail sent successfully' => 'テストメールが正常に送信されました',
    'Test mail failed to send' => 'テストメールを送信できませんでした',
    'Whether to open the password recovery function' => 'パスワード回復機能を開くかどうか',
    'Open the password recovery function' => 'パスワード回復機能を開きます',
    'SMTP settings must be completed before the password recovery function is enabled' => 'パスワード回復機能を有効にする前に、SMTP設定を完了する必要があります。'
];